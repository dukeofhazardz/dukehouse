...
const Stats = () => {
    return (
        <ContentWrapper>
            <div className="grid grid-cols-4 bg-white/25 w-full h-fit p-[0.5px] gap-[0.5px]">
                <div className="flex flex-col justify-center items-center text-center w-full h-full bg-black py-15">
                    <h1 className="text-5xl font-sans uppercase mb-3 tracking-tight">4+</h1>
                    <p className="text-white/55 text-xs uppercase">Years building software</p>
                </div>
                <div className="flex flex-col justify-center items-center text-center w-full h-full bg-black py-15">
                    <h1 className="text-5xl font-sans uppercase mb-3 tracking-tight">Cloud</h1>
                    <p className="text-white/55 text-xs uppercase">Architecture expertise</p>
                </div>
                <div className="flex flex-col justify-center items-center text-center w-full h-full bg-black py-15">
                    <h1 className="text-5xl font-sans uppercase mb-3 tracking-tight">Products</h1>
                    <p className="text-white/55 text-xs uppercase">Built and operated</p>
                </div>
                <div className="flex flex-col justify-center items-center text-center w-full h-full bg-black py-15">
                    <h1 className="text-5xl font-sans uppercase mb-3 tracking-tight">Security</h1>
