        ...
        <ContentWrapper>
            <div className="flex flex-col justify-start items-start mt-40">
                ...
                <div className="flex items-center mt-6 gap-5">
                    <button className="text-black uppercase tracking-[0.2em] text-xs font-sans bg-white py-5 px-10 cursor-pointer hover:bg-white/75 transition-all">Start a Project +</button>
                    <button className="text-white uppercase tracking-[0.2em] text-xs font-sans bg-none py-5 px-10 border border-white/55 cursor-pointer hover:border-gray-100 transition-all">Request an Audit +</button>
                </div>
