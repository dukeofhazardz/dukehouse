    ...
    return (
        <ContentWrapper>
            <div className="flex flex-col justify-start items-start mt-40">
                ...
                <h1 className="uppercase text-5xl">Review the system before risk becomes operational.</h1>
                ...
                <div className="grid grid-cols-2 mt-20 bg-white/25 p-px gap-[0.5px] box-border w-full h-full">
                    <div className="flex flex-col w-full h-full bg-black p-10 box-border">
                        ...
                        <Link href="#" className="mt-10 uppercase text-sm font-sans tracking-widest text-white/55">Discuss your architecture →</Link>
                    </div>
                    <div className="flex flex-col w-full h-full bg-black p-10 box-border">
